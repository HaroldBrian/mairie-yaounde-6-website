  ...
  return (
    <section className="section">
      <div className="container">
        ...
        <div className="banner-btn mt-9 flex items-center justify-center">
          <Link
            className="btn btn-outline-primary rounded-md px-20"
            href={speciality.link.href}
          >
            {speciality.link.label}
          </Link>
        </div>
      </div>
    </section>
